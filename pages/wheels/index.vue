    ...
    <div class="wheels">
      <div class="main__container">
        <div class="wheels-wrapper">
          <div class="wheels__category desktop">
            <div class="wheels__category-title">Category</div>
            <div class="wheels__category-list">
              <div class="wheels__category-item">
                <v-checkbox
          ...
          <div class="wheels__content">
            <div class="wheels__head">
              ...
              <div class="wheels__category mobile">
                <div class="wheels__category-title">Category</div>
                <div class="wheels__category-list">
                  <div class="wheels__category-item">
                    <v-checkbox
